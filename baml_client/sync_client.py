...
class BamlStreamClient:
    ...
    def ExtractShowInfo(
        ...
        files: List[types.TVShowFile],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[List[partial_types.TVShowInfo], List[types.TVShowInfo]]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      return baml_py.BamlSyncStream[List[partial_types.TVShowInfo], List[types.TVShowInfo]](
        raw,
